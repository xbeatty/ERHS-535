...
## Selecting for South American Countries
...
```
## Examining the data for children in South America
...
#add facet_wrap(~ Item) to plot overweight vs stunted in separate graphs
```
